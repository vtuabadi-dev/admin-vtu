...
export async function GET() {
  try {
    ...
    sheet.columns = [
      ...
      { header: "NO PASPOR", key: "noPaspor", width: 20 },
      { header: "TGL DIKELUARKAN", key: "tglDikeluarkan", width: 18 },
      { header: "TGL HABIS", key: "tglHabis", width: 18 },
      { header: "KOTA PASPOR", key: "kotaPaspor", width: 22 },
