            ...
            return (
              <div key={s.key} className="flex-1 flex items-start">
                <div className="flex flex-col items-center shrink-0">
                  ...
                  <span
                    className={cn(
                      "text-[11px] font-extrabold mt-1.5 text-center transition-colors drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]",
                      step === s.key && "text-slate-950 font-black",
                      step > s.key && "text-emerald-950 font-black",
                      step < s.key && "text-slate-600"
                    )}
                  >
                    {s.label}
                  </span>
                ...
                {i < steps.length - 1 && (
                  <div
                    className={cn(
                      ...
                      step > s.key ? "bg-emerald-800 shadow-xs" : "bg-white/60"
                    )}
                  />
                )}
              </div>
